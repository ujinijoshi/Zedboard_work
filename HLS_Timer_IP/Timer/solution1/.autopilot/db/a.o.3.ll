...
define void @Timer(i1* %PPS, i1* %pps_en, i32 %num_clks, i32 %hop_rate, i1* %trigger_out, i1* %pps_edge) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecReset(i1* @state, i32 1, [1 x i8]* @p_str) nounwind, !dbg !56 ; [debug line = 29:1]
  call void (...)* @_ssdm_op_SpecReset(i32* @ticks, i32 1, [1 x i8]* @p_str) nounwind, !dbg !58 ; [debug line = 30:1]
  call void (...)* @_ssdm_op_SpecReset(i32* @trigger_count, i32 1, [1 x i8]* @p_str) nounwind, !dbg !59 ; [debug line = 32:1]
  %PPS_read = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %PPS) nounwind, !dbg !60 ; [#uses=1 type=i1] [debug line = 35:2]
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !61 ; [debug line = 36:2]
  ...
  call void @_ssdm_op_Write.ap_auto.volatile.i1P(i1* %trigger_out, i1 false) nounwind, !dbg !62 ; [debug line = 60:4]
  store i32 0, i32* @ticks, align 4, !dbg !64     ; [debug line = 61:4]
  br i1 %state_load, label %5, label %1, !dbg !65 ; [debug line = 42:1]

; <label>:1                                       ; preds = %0
  store i32 0, i32* @trigger_count, align 4, !dbg !66 ; [debug line = 48:4]
  br label %2, !dbg !67                           ; [debug line = 50:4]

; <label>:2                                       ; preds = %3, %1
  %PPS_read_1 = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %PPS) nounwind, !dbg !67 ; [#uses=1 type=i1] [debug line = 50:4]
  br i1 %PPS_read_1, label %4, label %3, !dbg !67 ; [debug line = 50:4]

; <label>:3                                       ; preds = %2
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !68 ; [debug line = 51:5]
  br label %2, !dbg !70                           ; [debug line = 53:4]

; <label>:4                                       ; preds = %2
  call void @_ssdm_op_Write.ap_auto.volatile.i1P(i1* %trigger_out, i1 true) nounwind, !dbg !71 ; [debug line = 54:4]
  store i1 true, i1* @state, align 1, !dbg !72    ; [debug line = 55:4]
  br label %._crit_edge, !dbg !73                 ; [debug line = 56:4]

; <label>:5                                       ; preds = %0
  %trigger_count_load = load i32* @trigger_count, align 4, !dbg !74 ; [#uses=2 type=i32] [debug line = 62:4]
  call void @llvm.dbg.value(metadata !{i32* %hop_rate_assign}, i64 0, metadata !28), !dbg !74 ; [debug line = 62:4] [debug variable = hop_rate]
  %hop_rate_assign_load = load volatile i32* %hop_rate_assign, align 4, !dbg !74 ; [#uses=1 type=i32] [debug line = 62:4]
  %tmp_2 = add i32 %hop_rate_assign_load, -1, !dbg !74 ; [#uses=1 type=i32] [debug line = 62:4]
  %tmp_3 = icmp eq i32 %trigger_count_load, %tmp_2, !dbg !74 ; [#uses=1 type=i1] [debug line = 62:4]
  br i1 %tmp_3, label %6, label %.preheader, !dbg !74 ; [debug line = 62:4]

; <label>:6                                       ; preds = %5
  store i32 0, i32* @trigger_count, align 4, !dbg !75 ; [debug line = 63:5]
  store i1 false, i1* @state, align 1, !dbg !77   ; [debug line = 64:5]
  br label %._crit_edge, !dbg !78                 ; [debug line = 65:5]

.preheader:                                       ; preds = %7, %5
  %ticks_load = load i32* @ticks, align 4, !dbg !79 ; [#uses=2 type=i32] [debug line = 68:5]
  call void @llvm.dbg.value(metadata !{i32* %num_clks_assign}, i64 0, metadata !46), !dbg !79 ; [debug line = 68:5] [debug variable = num_clks]
  %num_clks_assign_load = load volatile i32* %num_clks_assign, align 4, !dbg !79 ; [#uses=1 type=i32] [debug line = 68:5]
  %tmp_5 = icmp eq i32 %ticks_load, %num_clks_assign_load, !dbg !79 ; [#uses=1 type=i1] [debug line = 68:5]
  br i1 %tmp_5, label %8, label %7, !dbg !79      ; [debug line = 68:5]

; <label>:7                                       ; preds = %.preheader
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !80 ; [debug line = 70:6]
  %tmp_7 = add i32 %ticks_load, 1, !dbg !82       ; [#uses=1 type=i32] [debug line = 71:6]
  store i32 %tmp_7, i32* @ticks, align 4, !dbg !82 ; [debug line = 71:6]
  br label %.preheader, !dbg !83                  ; [debug line = 72:5]

; <label>:8                                       ; preds = %.preheader
  call void @_ssdm_op_Write.ap_auto.volatile.i1P(i1* %trigger_out, i1 true) nounwind, !dbg !84 ; [debug line = 73:5]
  %tmp_6 = add i32 %trigger_count_load, 1, !dbg !85 ; [#uses=1 type=i32] [debug line = 74:5]
  store i32 %tmp_6, i32* @trigger_count, align 4, !dbg !85 ; [debug line = 74:5]
  br label %._crit_edge, !dbg !86                 ; [debug line = 76:5]

._crit_edge:                                      ; preds = %8, %6, %4
  ret void, !dbg !87                              ; [debug line = 78:1]
}
...
!56 = metadata !{i32 29, i32 1, metadata !57, null}
!57 = metadata !{i32 786443, metadata !29, i32 15, i32 1, metadata !30, i32 0} ; [ DW_TAG_lexical_block ]
!58 = metadata !{i32 30, i32 1, metadata !57, null}
!59 = metadata !{i32 32, i32 1, metadata !57, null}
!60 = metadata !{i32 35, i32 2, metadata !57, null}
!61 = metadata !{i32 36, i32 2, metadata !57, null}
!62 = metadata !{i32 60, i32 4, metadata !63, null}
!63 = metadata !{i32 786443, metadata !57, i32 43, i32 7, metadata !30, i32 1} ; [ DW_TAG_lexical_block ]
!64 = metadata !{i32 61, i32 4, metadata !63, null}
!65 = metadata !{i32 42, i32 1, metadata !57, null}
!66 = metadata !{i32 48, i32 4, metadata !63, null}
!67 = metadata !{i32 50, i32 4, metadata !63, null}
!68 = metadata !{i32 51, i32 5, metadata !69, null}
!69 = metadata !{i32 786443, metadata !63, i32 50, i32 21, metadata !30, i32 2} ; [ DW_TAG_lexical_block ]
!70 = metadata !{i32 53, i32 4, metadata !69, null}
!71 = metadata !{i32 54, i32 4, metadata !63, null}
!72 = metadata !{i32 55, i32 4, metadata !63, null}
!73 = metadata !{i32 56, i32 4, metadata !63, null}
!74 = metadata !{i32 62, i32 4, metadata !63, null}
!75 = metadata !{i32 63, i32 5, metadata !76, null}
!76 = metadata !{i32 786443, metadata !63, i32 62, i32 35, metadata !30, i32 3} ; [ DW_TAG_lexical_block ]
!77 = metadata !{i32 64, i32 5, metadata !76, null}
!78 = metadata !{i32 65, i32 5, metadata !76, null}
!79 = metadata !{i32 68, i32 5, metadata !63, null}
!80 = metadata !{i32 70, i32 6, metadata !81, null}
!81 = metadata !{i32 786443, metadata !63, i32 69, i32 5, metadata !30, i32 4} ; [ DW_TAG_lexical_block ]
!82 = metadata !{i32 71, i32 6, metadata !81, null}
!83 = metadata !{i32 72, i32 5, metadata !81, null}
!84 = metadata !{i32 73, i32 5, metadata !63, null}
!85 = metadata !{i32 74, i32 5, metadata !63, null}
!86 = metadata !{i32 76, i32 5, metadata !63, null}
!87 = metadata !{i32 78, i32 1, metadata !57, null}
